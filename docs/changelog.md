...
## 2026-07-17 新增「AI 项目现场资源调研」实践案例（项目管理版·最贴合主业）

### 变更
- 将耶鲁神学院停车场项目现场资源调研（原 yds-parking-resource-survey.html）复制并改造为 `yale-parking-project-survey.html`，加入「AI实践资源」
- **内容定位**：项目管理版——大型停车场建设项目，AI 摸排施工现场周边住宿/餐饮/交通/材料市场 4 维度共 24 个资源点，逐点给出项目决策建议，交互地图呈现
- **SEO优化**：标题改「AI 项目现场资源调研 · 耶鲁停车场建设项目实战案例（AI辅助生成）」，补 description / keywords（AI项目管理、项目现场调研、供应商调研等）/ og 标签，加 favicon + GA
- **AI 标注**：banner 内「🤖 本案例由 AI 辅助调研与生成 · 展示「AI + 项目管理」的落地能力」
- **回流引导**：底部靛紫 CTA（重点导回 AI 项目管理课程）+ 简易页脚
- **三页内容簇互链**：购物页、行程页 CTA 均新增指向本案例的按钮；本案例也反向链接另两页，形成「耶鲁」内容簇
- **主业页面双入口**：`ai-project-management.html` 在「已交付课程案例」上方新增靛紫「🗺 看 AI 如何用在真实项目上」活案例卡片，直接导向本案例（放主营页面比资源页更能促成转化）
- `resources.html` 的「AI实践资源」区块新增第三张卡片：AI 项目现场资源调研 · 耶鲁停车场建设项目

### 意义
- 前两个耶鲁案例（购物/游玩）是"流量入口"，这个是"能力证明"——直接展示 AI 用在真实项目管理场景，最贴合网站主业，最能促成课程转化

---

## 2026-07-17 新增「纽黑文2日游行程」AI实践案例（与购物攻略互补）

### 变更
- 将纽黑文2日游行程（原 new-haven-2day-itinerary.html）复制并改造为 `new-haven-yale-itinerary.html`，加入「AI实践资源（案例与可复用产物）」
- **SEO优化**：标题改为「纽黑文2日游行程 · 耶鲁大学周边游玩攻略（AI辅助生成）」，补充 description / keywords / og 标签，加入 favicon 与 GA 统计
- **AI标注**：banner 内加「🤖 本攻略由 AI 辅助调研与生成」标记
- **回流引导**：底部新增靛紫 CTA 区（导回 AI 项目管理课程 + 资源中心）+ 简易页脚
- **双向导流**：行程页 CTA 加「🛒 耶鲁周边购物攻略」按钮；购物攻略页 CTA 加「🏛 耶鲁周边 2 日游行程」按钮，两页互相链接形成攻略组合
- **resources.html**：「AI实践资源（案例与可复用产物）」区块新增入口卡片（17个景点 / v1.0 / 免费），与购物卡片并列

### 说明
- 行程页解决"去哪玩/去哪看"，购物页解决"去哪买"，二者覆盖耶鲁访学/看校/陪读/探亲人群的两类需求，构成"购物 + 游玩"攻略簇，强化耶鲁流量入口
